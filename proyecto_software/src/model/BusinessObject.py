...
class BusinessObject:
    def __init__(self):
        self.product = ProductBusinessObject()
        self.user = UserBusinessObject()
        self.service = ServiceBusinessObject()
        self.workshop = WorkshopBusinessObject()
        self.report = ReportBusinessObject()
